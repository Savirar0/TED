...
const Navbar = ({ activeLink }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <nav className="flex items-center bg-black backdrop-blur-sm border-b border-gray-700 relative z-10 md:flex-col md:items-start">       
      ...
      <motion.div 
        className="bg-black backdrop-blur-sm w-full absolute top-16 z-0" 
        initial="visible"
